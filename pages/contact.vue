    ...
    <div class="h-full bg-gray-50 dark:bg-slate-800 overflow-y-auto">
        <div class="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Contact Form -->
                <div class="bg-white/90 dark:bg-slate-700/90 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-slate-600">
                    <form @submit="onSubmit" class="space-y-6">
                        <div class="space-y-2">
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('contact.form.name') }}</label>
                            <input
                                id="name"
                                v-model="name"
                                type="text"
                        ...
                        <div class="space-y-2">
                            <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('contact.form.email') }}</label>
                            <input
                                id="email"
                                v-model="email"
                                type="email"
                        ...
                        <div class="space-y-2">
                            <label for="subject" class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('contact.form.subject') }}</label>
                            <input
                                id="subject"
                                v-model="subject"
                                type="text"
                        ...
                        <div class="space-y-2">
                            <label for="message" class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('contact.form.message') }}</label>
                            <textarea
                                id="message"
                                v-model="message"
                                rows="5"
                ...
                <div class="bg-white/90 dark:bg-slate-700/90 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-slate-600">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">{{ t('contact.social.title') }}</h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <NuxtLink to="https://www.linkedin.com/in/chad-feierstein/"
                            target="_blank"
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    class="p-2.5 bg-blue-100 dark:bg-blue-900 rounded-lg group-hover:bg-blue-200 dark:group-hover:bg-blue-800 transition-colors">
                                    <Icon name="mdi:linkedin" size="24" class="text-blue-600 dark:text-blue-400" />
                                </div>
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-white">{{ t('contact.social.linkedin.title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('contact.social.linkedin.subtitle') }}</p>
                                </div>
                            </div>
                        </NuxtLink>

                        <NuxtLink to="https://github.com/FChad?tab=repositories"
                            target="_blank"
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    class="p-2.5 bg-gray-200 dark:bg-gray-700 rounded-lg group-hover:bg-gray-300 dark:group-hover:bg-gray-600 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('contact.social.github.subtitle') }}</p>
                                </div>
                            </div>
                        </NuxtLink>

                        <NuxtLink to="https://www.instagram.com/chadfeierstein/"
                            target="_blank"
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    class="p-2.5 bg-pink-100 dark:bg-pink-900 rounded-lg group-hover:bg-pink-200 dark:group-hover:bg-pink-800 transition-colors">
                                    <Icon name="mdi:instagram" size="24" class="text-pink-600 dark:text-pink-400" />
                                </div>
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-white">{{ t('contact.social.instagram.title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('contact.social.instagram.subtitle') }}</p>
                                </div>
                            </div>
                        </NuxtLink>

                        <NuxtLink to="https://www.facebook.com/chad.feierstein.7/"
                            target="_blank"
                            class="group bg-gray-50 dark:bg-slate-800 p-4 rounded-xl hover:bg-blue-50 dark:hover:bg-slate-900 transition-colors border border-gray-100 dark:border-slate-600">
                            <div class="flex items-center gap-3">
                                <div
                                ...
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-white">{{ t('contact.social.facebook.title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('contact.social.facebook.subtitle') }}</p>
                                </div>
                            </div>
                        </NuxtLink>
                    </div>
